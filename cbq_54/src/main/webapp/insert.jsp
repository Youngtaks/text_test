...
<script>
	...
	function send(){
		...
		if(frm.class_name.value==="00"){
			alert("강의 선택이 선택되지 않았습니다.");
				...
				<form name="frm" method="post" action="insert_pro.jsp">
					<table>
						<tr>
							<th>수강월</th>
							<td>
							<input type="text" name="regist_month" value="<%=nvl%>">2026년 02월 예)202602
							</td>						
							</tr>
					<tr>
						<th>회원명</th>
					...
					<tr>
						<th>회원번호</th>
						<td>
					<input  name="c_no" id="c_no" readonly>예)10001
					</td>
					</tr>
					<tr>
						<th>강의장소</th>
					...
					<tr>
						<th>강의선택</th>
						<td>
							<select name="class_name" onchange="getvalue1(this.value)">
								<option value="00">강의선택</option>
					...
					<tr>
						<th>강의료</th>
						<td>
							<input id="tuition" name="tuition" readonly>원
						</td>
					</tr>
					<tr>
