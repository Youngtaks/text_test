				...
				<div class="content">
					<h2 class="title">작업지시조회</h2>
						...
						<tr>
							...
							<th><%=dto.getP_size()%></th>
							<th><%=dto.getP_type()%></th>
							<th><%=dto.getW_quentity()%></th>
							<th><%=dto.getW_workdate().substring(0,4)+"년"+dto.getW_workdate().substring(4,6)+"월"+dto.getW_workdate().substring(6,8)+"일"%></th>
						</tr>
						<%
						}
						%>
