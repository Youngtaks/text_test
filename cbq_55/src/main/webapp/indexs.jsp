	...
	<div class="header">
		<header>
			...
			<div class="nav">
				<ul class="navi">
					<li><a href="">차량조회</a></li>
					<li><a href="">주행내역등록</a></li>
					<li><a href="">주행내역조회</a></li>
					<li><a href="">부서별주행통계</a></li>
					<li><a href="">홈으로</a></li>
	...
	<div class="section">
		<section>
			<div class="content">
				...
				<br><br>국가직무능력표준(NCS:National Competency Standards)으로 설계된 교육*훈련과정을 체계적으로 이수하고 내외부 평가를 거쳐 취득하는 국가기술자격입니다.<br>
					<br>산업현장 중심의 교육평가로 더 커지는 능력!<br>
					<br>알고 있는 것에 할 수 있는 것을 더하는<br>
					<br>과정평가형 자격은<br>
					<br>현장 중심형 인재육성을 지원 합니다.<br><br>
			</div>
		</section>
	</div>
	<div class="footer">
